...
export default function QuickStartPage() {
  ...
  "mcpServers": {
    "vibe-hnindex": {
      ...
      <h2 id="4-restart">4. Restart Your AI Tool</h2>
      <p>Restart Claude, Cursor, Antigravity, or whatever MCP client you use.</p>

      <h2 id="5-first-index">5. Index Your First Project</h2>
      ...
      <h2 id="6-search">6. Search Your Code</h2>
...
List all indexed projects`}</code></pre>
      ...
      <h2 id="7-smart-context">7. Try Smart Context</h2>
      <p>
